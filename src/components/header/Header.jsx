...
const Header = ({ onNavigateFun }) => {
  ...
  useEffect(() => {
    document.body.classList.toggle('nav-menu-open', toggle);
  }, [toggle]);
      ...
      <nav className="nav container">
        ...
        <div className={toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className="nav__list">
            <li className="nav__item"><a href="#home" className="nav__link active-link" onClick={() => setToggle(false)}><i className="uil uil-estate nav__icon"></i>Home</a></li>
            <li className="nav__item"><a href="#about" className="nav__link" onClick={() => setToggle(false)}><i className="uil uil-user nav__icon"></i>About</a></li>
            <li className="nav__item"><a href="#skills" className="nav__link" onClick={() => setToggle(false)}><i className="uil uil-file-alt nav__icon"></i>Skills</a></li>
